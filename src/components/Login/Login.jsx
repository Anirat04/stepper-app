        ...
        <div className='bg-white h-full'>
            <div className='px-5 pt-[40px]'>
                ...
                <div className='text-center'>
                    <h2 className='text-black text-[26px] font-bold' >Welcome Back!</h2>
                        ...
                        <div className='my-8'>
                            <div className='relative mb-5'>
                                <input
                                    ...
                                    {...register("username")}
                                    className='bg-white border w-full py-3 rounded-lg pl-12 outline-0'
                                />
                                <span className='absolute left-4 top-1/2 -translate-y-1/2'><CiUser className='text-[22px]'></CiUser></span>
                            </div>
                            <div className="relative">
                                <input
                                    ...
                                    className='bg-white border w-full py-3 rounded-lg pl-12 outline-0'
                                />
                                <span className='absolute left-4 top-1/2 -translate-y-1/2'><CiLock className='text-[22px]'></CiLock></span>
